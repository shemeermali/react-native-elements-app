        ...
        <View style={styles.contentView}>
          <View style={{ backgroundColor: '#2F343B', width: SCREEN_WIDTH, alignItems: 'center' }}>
            ...
            <View style={styles.overlay}>
              ...
              <Input
                ...
                icon={<MaterialIcon name="email-outline" color="black" size={25} />}
                placeholder="Email"
            ...
            <View style={[styles.overlay, { marginBottom: 30, marginTop: 1 }]}>
              ...
              <Input
                ...
                icon={<SimpleIcon name="lock" color="black" size={25} />}
          ...
          <View
            ...
            <Input
              ...
              icon={<SimpleIcon name="user" color="rgba(110, 120, 170, 1)" size={25} />}
